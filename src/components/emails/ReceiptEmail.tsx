...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your DarkObs Receipt</Preview>
...
const heading = {
  fontSize: "28px",
  fontWeight: "300",
  color: "#b0b0b0", // Softer gray for heading
};

const informationTable = {
  borderCollapse: "collapse" as const,
  borderSpacing: "0px",
  backgroundColor: "#2a2a2a", // Darker table background
  borderRadius: "3px",
  fontSize: "12px",
  marginTop: "12px",
};
...
const productLink = {
  fontSize: "12px",
  color: "#4a90e2", // Blue link for contrast
  textDecoration: "none",
};
